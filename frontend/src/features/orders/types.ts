import type { Currency, Payment } from '../payments/types';
...
export type OrderInvoiceCreditNote={id:string;number:string;status:string;currency:Currency;grand_total:string;reason:string};
