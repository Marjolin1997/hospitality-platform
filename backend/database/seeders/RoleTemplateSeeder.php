...
class RoleTemplateSeeder extends Seeder{
 public function run():void{
  $templates=[
   'owner'=>['*'],
   'manager'=>['orders.*','payments.*','cash_sessions.*','cash_movements.create','products.*','inventory.*','finance.view','expenses.*','invoices.*','reports.*','users.view'],
   ...
   'finance'=>['orders.view','finance.view','expenses.*','invoices.*','reports.financial.view'],
  ];
  $all=Permission::all();
